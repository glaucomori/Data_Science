...
[(clique aqui para ver o meu perfil na plataforma)](https://web.digitalinnovation.one/users/glaucoipmori)
#### Tecnologia: Python
#### Data: 17/10/2022
-----------------------------------------
### Descrição
...
# Henrique Matheus Alves Pereira (estou usando o arquivo do Henrique como base para aprendizado)
